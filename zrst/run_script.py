...
corp_path = '/home/c2tao/phd/GlobalPhone_subset/{}/wav/train/'
dump_path = '/home/c2tao/phd/initial/{}_{}_{}.txt'
patt_path = '/home/c2tao/phd/pattern/{}_{}_{}_{}/'


# ######################phase0####################
'''
def build_initial(L, M):
    wave = corp_path.format(L)
...
for N in N_list:
    for M in M_list:
        for O in O_list:
            build_pattern(sys.argv[1],M,N,O)
# ## set paths ###
'''
